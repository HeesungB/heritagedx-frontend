...
export default function MembershipTradesSection() {
  ...
  // 클라이언트 필터링: 회원권 선택 시 네트워크 요청 없이 즉시 필터
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gray-50 rounded-lg border border-gray-200 p-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <select
            ...
            className="border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs focus:outline-none focus:border-gray-400 disabled:bg-gray-100 disabled:text-gray-400"
          >
          ...
          <div className="flex-1 min-w-[160px] relative">
            <input
              ...
              className="w-full px-2.5 py-1.5 pr-8 border border-gray-200 rounded-lg text-xs focus:outline-none focus:border-gray-400"
            />
          ...
          <select
            ...
            className="border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs focus:outline-none focus:border-gray-400"
          >
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex justify-end gap-2 pt-1">
              <Button type="button" variant="outline" size="sm" onClick={handleCancelForm}>취소</Button>
              <Button type="submit" size="sm" disabled={submitting} isLoading={submitting}>{editingTrade ? "수정" : "저장"}</Button>
            </div>
          </form>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        {loading ? (
          <div className="py-12 flex justify-center"><Loading size="sm" text="로딩 중..." /></div>
        ) : trades.length === 0 ? (
          <div className="py-12 text-center">
            <p className="text-gray-400 text-sm mb-2">등록된 거래 내역이 없습니다</p>
            <button
                        ...
                        {deleteConfirmId === trade.id ? (
                          <div className="flex items-center gap-0.5">
                            ...
                            <button
                              ...
                              className="px-1.5 py-0.5 border border-gray-300 text-[10px] rounded hover:bg-gray-100"
                            >
                              취소
                            </button>
                          </div>
