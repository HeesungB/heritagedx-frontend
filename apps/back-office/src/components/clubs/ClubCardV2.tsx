...
export default function ClubCardV2({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`group flex flex-col gap-2 p-[12px_14px_14px] bg-surface border border-neutral-200 rounded-[10px] text-left cursor-pointer transition-all hover:border-[#C4C4C2] hover:-translate-y-px hover:shadow-[0_1px_3px_rgba(0,0,0,0.04)] ${className}`}
    >
      <div className="flex items-start gap-1.5 justify-between">
        ...
        <button
          ...
          className={`ml-auto w-[22px] h-[22px] grid place-items-center bg-transparent border-none cursor-pointer rounded transition-colors ${
