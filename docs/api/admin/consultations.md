...
> ↔ 공개 대응: [../consultations.md](../consultations.md)

## 엔드포인트 목록

| Method | Path | 설명 | 인증 |
|---|---|---|---|
| `GET` | `/api/admin/consultations` | [Admin] 상담 기록 목록 조회 | 🔒 |
| `POST` | `/api/admin/consultations` | [Admin] 상담 기록 등록 | 🔒 |
| `GET` | `/api/admin/consultations/{id}` | [Admin] 상담 기록 상세 조회 | 🔒 |
| `PUT` | `/api/admin/consultations/{id}` | [Admin] 상담 기록 수정 | 🔒 |
| `DELETE` | `/api/admin/consultations/{id}` | [Admin] 상담 기록 삭제 | 🔒 |
| `PATCH` | `/api/admin/consultations/{id}/approval-action` | [Admin] 상담 승인 액션 처리 | 🔒 |

## 엔드포인트 상세

### `GET /api/admin/consultations`

- **Summary**: [Admin] 상담 기록 목록 조회
- **OperationId**: `AdminConsultationsController_findAll`
...
- **Summary**: [Admin] 상담 기록 등록
- **OperationId**: `AdminConsultationsController_create`
- **인증**: 필요 (쿠키 `hdx_access_token`)
...
- **Summary**: [Admin] 상담 기록 상세 조회
- **OperationId**: `AdminConsultationsController_findOne`
- **인증**: 필요 (쿠키 `hdx_access_token`)
...
- `200` 상세 조회 성공 → [`ConsultationDetailResponseDto`](#consultationdetailresponsedto)

#### 실호출 샘플 (2026-04-17)

```http
GET /api/admin/consultations/4a720352-762f-414f-95b6-b206d9788360
Cookie: hdx_access_token=<JWT>
```
...
```json
{
  ...
  "timestamp": "2026-04-17T11:38:18.382Z"
}
```

### `PUT /api/admin/consultations/{id}`

- **Summary**: [Admin] 상담 기록 수정
- **OperationId**: `AdminConsultationsController_update`
- **인증**: 필요 (쿠키 `hdx_access_token`)
...
- **Summary**: [Admin] 상담 기록 삭제
- **OperationId**: `AdminConsultationsController_remove`
- **인증**: 필요 (쿠키 `hdx_access_token`)
...
### `PATCH /api/admin/consultations/{id}/approval-action`

- **Summary**: [Admin] 상담 승인 액션 처리
- **OperationId**: `AdminConsultationsController_handleApprovalAction`
- **인증**: 필요 (쿠키 `hdx_access_token`)
