...
export default function TypeBadge({ tradeType, isUndecided, isDone }: TypeBadgeProps) {
  ...
  const palette = isDone ? "bg-gray-100 text-gray-400 border-gray-200" : PALETTE[key];
  return (
    <span
